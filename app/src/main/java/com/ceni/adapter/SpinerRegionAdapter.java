...
public class SpinerRegionAdapter extends BaseAdapter {
    ...
    public SpinerRegionAdapter(Activity context, int listItemLayoutResource,
    ...
    public long getItemId(int position) {
        Region region = (Region) this.getItem(position);
